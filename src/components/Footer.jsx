...
const quickLinks = [
    ...
    { to: "/login",         label: "Log ind / bliv bruger" },
]

export default function Footer() {
    return (
        <footer className="w-full font-sans">
            <div className="bg-ui-bg-1 pt-16 pb-12 px-6">
                <div className="max-w-7xl mx-auto">
                    <div className="mb-12">
                        <HouseLogo />
                        <p className="mt-4 max-w-lg text-para-2">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
                        <div className="md:col-span-4 relative z-20">
                            <div className="bg-white p-10 shadow-xl border border-slate-50 md:absolute md:top-0 md:left-0 md:right-0">
                                <div className="space-y-8">
                                    ...
                                    <ContactItem 
                                        Icon={Mail} 
                                        label="Send en mail" 
                                        value="4000@dinmaegler.com" 
                                    />
                                    <ContactItem 
                                        Icon={MapPin} 
                                        label="Butik" 
                                        value="Stændertorvet 78, 4000 Roskilde" 
                                    />
                                    <p className="pt-6 text-sm text-para-2 border-t border-slate-100">
                        ...
                        <div className="md:col-start-6 md:col-span-5 py-2">
                            <h3 className="font-bold text-xl mb-6 text-primary-1">Quick Links</h3>
                            <ul className="space-y-4">
                                {quickLinks.map((link) => (
                                    <li key={link.to}>
                                        <Link to={link.to} className="text-para-2 hover:text-primary-1 transition-colors">
                                            {link.label}
                                        </Link>
                                    </li>
                                ))}
            ...
            <div className="bg-primary-1 py-6 text-center">
                <p className="text-white text-para-3">
...
function ContactItem({ Icon, label, value }) {
    return (
        <div className="flex items-center gap-5">
            <div className="w-12 h-12 flex items-center justify-center bg-primary-1 text-white rounded-full shrink-0">
                <Icon size={18} />
            </div>
            <div>
